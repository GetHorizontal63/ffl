document.addEventListener('DOMContentLoaded', function() {
    ...
    function findTeamRoster(teamName, rosterData) {
        ...
        if (!team) {
            ...
            console.log('Available teams:', rosterData.teams.map(t => t.team_name || t.owner));
            return null;
        }
        ...
        rawData.forEach(entry => {
            ...
            if (!gamesByID[gameId]) {
                gamesByID[gameId] = {
                    ...
                    team2Score: entry["Opponent Score"],
    ...
    async function enrichGamesForWeek(games, season, week) {
        ...
        games.forEach(game => {
            ...
            const team1Roster = findTeamRoster(game.team1, rosterData);
            const team2Roster = findTeamRoster(game.team2, rosterData);
    ...
    function searchGames() {
        ...
        filteredGames.sort((a, b) => {
            switch (sortBy) {
                ...
                case 'score-desc':
                    return (b.team1Score + b.team2Score) - (a.team1Score + a.team2Score);
                case 'score-asc':
                    return (a.team1Score + a.team2Score) - (b.team1Score + b.team2Score);
                case 'fpplus-desc':
    ...
    function displayGames() {
        ...
        currentGames.forEach(game => {
            ...
            const team1IsWinner = game.team1Score > game.team2Score;
            const team2IsWinner = game.team2Score > game.team1Score;
            ...
            team1Row.innerHTML = `
                ...
                <div class="result-cell ${team1IsWinner ? 'high-score' : ''}" data-label="Score">${game.team1Score.toFixed(2)}</div>
                ...
                <div class="result-cell ${team2IsWinner ? 'high-score' : ''}" data-label="Score">${game.team2Score.toFixed(2)}</div>
